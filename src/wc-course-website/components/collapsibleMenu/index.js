...
class CollapsibleMenu extends window.HTMLElement {
  constructor() {
    super();

    this.contentTemplateId = '#collapsible-menu';
  ...
  /**
   * Updates the content of the collapsible menu without deleting the entire HTML.
   */
  update() {
  ...
  /**
   * Renders the collapsible menu and it's template inside of the DOM structure. Will delete all the HTML that
  ...
  render() {
    ...
    const chevronTemplate = contentNode.querySelector('[data-element="closed"]').content;
    innerNode.style.transition = 'max-height 0.5s cubic-bezier(0, 1, 0, 1)';
    innerNode.style['max-height'] = '0';
    innerNode.style['padding-bottom'] = '0';
